...
export const uiCopy = {
  en: {
    ...
    bookingForm: {
      ...
      intro:
        "Submit your details and choose how you’d like us to reply. You can send the prepared message via WhatsApp or call us directly.",
      fullName: "Full name",
      phone: "Phone",
      concern: "Concern",
      ...
      previewReady: "Send this message via WhatsApp or call us directly.",
  ...
  zh: {
    ...
    bookingForm: {
      eyebrow: "预约申请",
      intro: "填写你的资料，并选择希望我们如何回复你。你可以通过 WhatsApp 发送已准备好的讯息，或直接致电我们。",
      fullName: "姓名",
      phone: "电话",
      concern: "肌肤问题",
      ...
      viewLocation: "查看位置",
      previewLabel: "讯息预览",
      previewReady: "现在可通过 WhatsApp 发送这则讯息，或直接致电我们。",
  ...
  ms: {
    ...
    bookingForm: {
      ...
      intro: "Isi butiran anda dan pilih cara anda mahu kami balas. Anda boleh hantar mesej yang disediakan melalui WhatsApp atau terus hubungi kami.",
      fullName: "Nama penuh",
      phone: "Telefon",
      ...
      previewReady: "Hantar mesej ini melalui WhatsApp atau terus hubungi kami.",
